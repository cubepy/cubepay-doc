...
**آیا نیاز به درگاه بانکی رسمی دارم؟** ❌ نه، فقط یک کارت بانکی به نام خودتون کافیه.
**فاکتورها چند دقیقه اعتبار دارن؟** ⏳ ۳۰ دقیقه.
**اگه پیامک بانک دیر برسه چی؟** تا وقتی فاکتور منقضی نشده، تشخیص انجام می‌شه؛ تاخیر پیامک بانک معمولاً چند ثانیه‌ست.
**چطور توکن یا کارتم رو عوض کنم؟** از منوی ربات مدیریت فروشندگان (`@cubepy_bot`).
