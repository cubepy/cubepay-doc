...
CubePay یک API
ساده برای ساخت و تایید تراکنش‌های کارت‌به‌کارت است. مشتری شما مبلغ را مستقیم به کارت شما واریز می‌کند و تاییدش کاملاً خودکار (از روی پیامک بانکی) انجام می‌شود — دقیقاً مثل یک درگاه پرداخت، ولی بدون نیاز به نماد و ثبت درگاه رسمی.

**آیا فروشنده نیاز به نماد اعتماد الکترونیکی (اینماد) یا کد اقتصادی/مالیاتی داره؟**
❌ نه. چون پرداخت به‌صورت کارت‌به‌کارت مستقیم انجام می‌شه، نه از طریق درگاه بانکی رسمی، فروشنده هیچ‌وقت نیازی به این‌ها نداره — فقط یک کارت بانکی معتبر به نام خودش کافیه.
...
سایت معرفی کیوب‌پی: https://cubevps.ir
شامل توضیح خدمات، مستندات خلاصه‌ی API، و اطلاعات تماس/پشتیبانی.
