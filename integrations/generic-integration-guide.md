...
> 📌 اگه از فایل‌های آماده‌ی ما یا یه ربات آماده (فاکسیما / میرزابات) استفاده می‌کنید، این بخش برای شما نیست — مالِ کسیه که کدِ ربات رو خودش نوشته. راهنمای دسته‌ی خودتون: [نمایش کارت داخل ربات](../docs/CARD-IN-BOT.md)
