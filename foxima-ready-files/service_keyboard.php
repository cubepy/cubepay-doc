...
$MENUS = [
    ...
    'admin_gateways' => [
        ...
        'desc'  => 'منوهای تنظیمات تمام درگاه‌های پرداخت (کارت‌به‌کارت، ترنادو، زرین‌پال، کیوب‌پی، آقای پرداخت، Plisio).',
        'buttons' => [
            ...
            'zpey_name'        => '🗂 نام درگاه کیوب‌پی',
            'zpey_token'       => '🔑 توکن کیوب‌پی',
            'zpey_cashback'    => '💰 کش‌بک کیوب‌پی',
            'zpey_tutorial'    => '🧑🏼‍💻 آموزش اتصال کیوب‌پی',
            'zpey_min'         => '⬇️ حداقل مبلغ کیوب‌پی',
            'zpey_max'         => '⬆️ حداکثر مبلغ کیوب‌پی',
            'zpey_edu'         => '📚 تنظیم آموزش کیوب‌پی',
            'zpey_back'        => '◀️ بازگشت (کیوب‌پی)',
    ...
    'admin_gateway_extra' => [
        ...
        'buttons' => [
            ...
            'zarinpeysetting'          => '⚙️ تنظیمات کیوب‌پی',
