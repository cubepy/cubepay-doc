...
$keyboardzarinpey = rx_kb_encode([
        [
            rx_kb_style(['text' => "🗂 نام درگاه کیوب پی", 'callback_data' => 'zpey_name'], 'zpey_name', $_rx_gw_styles),
            rx_kb_style(['text' => "🔑 توکن کیوب پی", 'callback_data' => 'zpey_token'], 'zpey_token', $_rx_gw_styles)
        ],
        [rx_kb_style(['text' => "💰 کش بک کیوب پی", 'callback_data' => 'zpey_cashback'], 'zpey_cashback', $_rx_gw_styles)],
        [rx_kb_style(['text' => "🧑🏼‍💻 اموزش اتصال", 'callback_data' => 'zpey_tutorial'], 'zpey_tutorial', $_rx_gw_styles)],
        [
            rx_kb_style(['text' => "⬇️ حداقل مبلغ کیوب پی", 'callback_data' => 'zpey_min'], 'zpey_min', $_rx_gw_styles),
            rx_kb_style(['text' => "⬆️ حداکثر مبلغ کیوب پی", 'callback_data' => 'zpey_max'], 'zpey_max', $_rx_gw_styles)
        ],
        [
            rx_kb_style(['text' => "🧾 کارمزد ثابت (روشن/خاموش)", 'callback_data' => 'zpey_fee_toggle'], 'zpey_fee_toggle', $_rx_gw_styles),
            rx_kb_style(['text' => "💵 مبلغ کارمزد ثابت", 'callback_data' => 'zpey_fee_amount'], 'zpey_fee_amount', $_rx_gw_styles)
        ],
        [rx_kb_style(['text' => "📚 تنظیم آموزش کیوب پی", 'callback_data' => 'zpey_edu'], 'zpey_edu', $_rx_gw_styles)],
        [
