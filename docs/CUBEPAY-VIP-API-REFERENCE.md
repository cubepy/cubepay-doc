...
به **«قابل‌تسویه»** منتقل می‌شود. هیچ کارِ دستی لازم نیست؛ خودش سرِ موعد
آزاد می‌شود.

> ⏳ **دوره‌ی پیش‌فرض ۷ روز (۱۶۸ ساعت) است.** یعنی طبیعی است که موجودیِ
> «قابل‌تسویه» چند روز ثابت بماند در حالی که «در انتظار» عدد دارد — پول گم
> یا گیر نشده، فقط هنوز موعدِ آزادسازی‌اش نرسیده. این دوره برای این است که
> اگر واریزی برگشت خورد، پیش از برداشت رسیدگی شود.
>
> **چرا این دوره وجود دارد:** واریزِ کارت‌به‌کارت تا چند روز قابلِ برگشت
> است، ولی تسویه‌ی ما (ارزی) برگشت‌ناپذیر است. دوره‌ی نگهداری همین شکاف را
> می‌پوشاند.
